...
title: "[Devlogs Maker] #2: Brief Overview of Basic Features"
description: "The minimum features in the app so far can: post devlogs; get devlogs & edit them; & delete devlogs. Import formatted devlogs & export them to system. Clear text for a clean slate. Verify/refresh tokens for user."
featuredImage: ""
tags: [devlogs maker, tool, software]
---

## >> Intro

Hi everyone, I'm going to get to the basic features (suppose this is a MVP) of Devlogs Maker. I went over the basic process in my [last devlog](https://jennydevs.github.io/devlogs/log/2025_06_08_0).
